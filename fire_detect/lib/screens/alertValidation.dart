...
class AlertValidation extends StatefulWidget{
  @override
  State createState() => new AlertValidationState();
}

class AlertValidationState extends State<AlertValidation>{
                ...
                children : <Widget>[
                  Expanded(
                    child: Center(
                      child: Container(
                        child : InkWell(
                          child : Text("Confirm Alert", style: TextStyle(
                            fontSize : 30.0,
                  ...
                  Expanded(
                    child: Center(
                      child: Container(
                        child : InkWell(
                          child : Text("Deny Alert", style: TextStyle(
                            fontSize : 30.0,
                            fontWeight : FontWeight.bold,
                            color : Colors.white
                          ),),
